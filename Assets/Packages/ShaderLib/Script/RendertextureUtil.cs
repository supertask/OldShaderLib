...
namespace UGist {
    ...
    public class PingPongRenderTexture : IDisposable {
        ...
        public PingPongRenderTexture(int w, int h, int depth, RenderTextureFormat format, FilterMode filter = FilterMode.Point, TextureWrapMode wrap = TextureWrapMode.Clamp) {
